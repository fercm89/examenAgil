Este producto contratado consiste en la creación de una calculadora que permita sumar, restar y multiplicar numeros naturales.
...
1)Suma, la duración sería de 1 semana y el compromiso sería para el primer sprint(test unitario, programa suma)
2)Multiplicación, la duración sería de 1 semana y el compromiso sería para el primer sprint(test unitario,programa multiplicar)


SPRINT 2


1)Resta, la duración sería de 1 semana y la comprobación seria para el segundo sprint(test unitario,programa resta)
2)Compruebo si la resta da error o no, la duración sería de 1 semana y el compromiso sería para el segundo sprint(test unitario,programa error resta)
3)Numeros romanos, la duración sería de 1 semana y el compromiso seria para el segundo sprint(test unitario,programa nº romanos)

Según los recursos que tenemos para este proyecto, y el número de integrantes del equipo hemos considerado que podemos realizar el proyecto 
...
Por tanto, consideramos que el proyecto estaría finalizado en un tiempo aproximado de 2 semanas.
